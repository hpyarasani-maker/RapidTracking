    ...
    public class Desktop
    {
        ...
        public string ProcessDocument(string seid, string keyword, HtmlDocument doc, out int count)
        {
            ...
            try //28-09-2020  try catch.
            {
                ...
                if (nodeCol == null && (doc.DocumentNode.SelectNodes(".//div[contains(@class,'TzHB6b cLjAic')]") == null))//30-10-2023
                ...
                if (nodeCol == null || nodeCol.Count <= 4)//02-05-2023//21-04-2023
                    nodeCol = doc.DocumentNode.SelectNodes(".//div[@class='WvKfwe a3spGf']/div|.//div[@class='TzHB6b cLjAic LMRCfc']") ?? nodeCol;//30-10-2023//21-09-2023 //19-09-2023
