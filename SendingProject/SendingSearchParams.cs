        ...
        public static IList<SearchProperties> searches = new List<SearchProperties>()
        {
         ...
         new SearchProperties()
           ...
           new SearchProperties()
            ...
            new SearchProperties() //UKDesktopImages_ImageURLs
            {
                seid = 381,domain ="co.uk",geo_location="United Kingdom", locale="en-gb", uule="w+CAIQICIOVW5pdGVkIEtpbmdkb20=",device="desktop",tbm="isch"
            },
            ...
            {
                seid = 383,domain ="co.uk",geo_location="United Kingdom", locale="en-gb", uule="w+CAIQICIOVW5pdGVkIEtpbmdkb20=",device="mobile_android",tbm="isch"
            },
              new SearchProperties()
            {
