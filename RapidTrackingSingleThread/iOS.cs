...
namespace RapidTrackingSingleThread
{
    class iOS
    {
        ...
        private string GetBottomStuff(HtmlDocument doc)
        {
            ...
            HtmlNodeCollection col = doc.DocumentNode.SelectNodes("//div[@id='tadsb']/div[@class='C4eCVc c']/ol/li|.//div[@id='tadsb']/div/div[@class='uEierd']");//28-03-2022 "/div" included //18-09-2020 included selector for bottom adwords // 24-04-2020   included class selector
            if (col != null)
            {
        ...
        private string GetTopStuff(HtmlDocument doc)
        {
            ...
            if (crNode != null)
            {
                ...
                if (col == null)
                    col = doc.DocumentNode.SelectNodes("//div[@id='tads']/div/ol/li|//div[@jsname='hWE2jd']|//div[@id='tads']/div/div[@class='uEierd']|//div[@id='tads']/div[@class='mnr-c O9g5cc uUPGi']");//28-03-2022 "/div" included//04-10-2021 updated selector for missing adwords
