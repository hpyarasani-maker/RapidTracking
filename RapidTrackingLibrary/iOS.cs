    ...
    public class iOS
    {
        ...
        public string ProcessOrganic(HtmlNode node)
        {
            ...
            else
            {
                ...
                if (nds == null && (node.Attributes["jsname"]?.Value == "pKB8Bc" || node.Attributes["class"]?.Value == "Ww4FFb vt6azd"))//13-08-2024//14-02-2024
                    ...
                    try
                    {
                            ...
                            if (img != null)
                            {
                                try
                                {
                                    ...
                                    if (Regex.IsMatch(img.OuterHtml, "id=\"vidthumb\\d*\"") || Regex.IsMatch(img.OuterHtml, "id=\"dimg_\\d*\"") || img.Attributes["class"].Value.Contains("__video-result") || nd.SelectSingleNode(".//div[contains(@class,'c8rnLc flgn0c')]") != null || nd.SelectSingleNode(".//video-voyager") != null || nd.SelectSingleNode(".//div[@class='J1mWY']") != null)//10-06-2023//29-03-2023//23-03-2023//08-05-2021 contains//09-02-2021 //05-01-2021 //21-12-2020//16-12-2020 //14-12-2020
                                    {
                                        ...
                                        // video block.
                                        if (vdo == null)
                                            vdo = nd.SelectSingleNode(".//div[@class='th N3nEGc']/a|.//a[@class='d3q37c']"); vdo = nd.SelectSingleNode(".//div[@class='th N3nEGc']/a|.//a[@class='d3q37c']|.//div[@class='T61Aje v5yQqb']/a");//19-09-2024
                        ...
                        else if (nd.Attributes["class"] != null || nd.Attributes.Count == 0)
                        {
                            if (nd.Attributes.Count == 0 || nd.Attributes["class"].Value == "mnr-c" || nd.Attributes["class"].Value == "mnr-c xpd O9g5cc uUPGi"
                             ...
                             || nd.Attributes["class"].Value == "wU9Tkd" || nd.Attributes["class"].Value.Contains("P8ujBc") || nd.Attributes["class"].Value == "AGopnf"//30-09-2024                                                                                                                    // || nd.Attributes["class"].Value.Contains("mnr-c xpd EtOod pkphOe")//30-09-2022 commented //10-06-2022
                             ...
                             || nd.Attributes["class"].Value == "g card-section" || nd.Attributes["class"].Value == "card-section svwwZ" || nd.Attributes["class"].Value == "kb0PBd cvP2Ce jGGQ5e") //04-06-2024
                            {
                                //17-10-2019
                                string vdos = string.Empty;
                                vdos = SetVideos(nd);
        ...
        //start 13-08-2019
        public string ProductListedAds(HtmlNode node)//15-10-2024
        {
            StringBuilder s = new StringBuilder();
        ...
        /*private string PeopleAlsoAsk(HtmlNode node)//commented 19-01-2022
       {
        ...
        public string GetHotels(HtmlNode node)//24-03-2022 new element Maps//15-11-2024 removed url from blocktype and item elements
        {
            StringBuilder s = new StringBuilder();
        ...
        public string GetBlockType(HtmlNode node)
        {
            ...
            if (node.SelectSingleNode(".//div[@id='imso-root']") != null || node.SelectSingleNode(".//div[contains(@class,'tsp-view')]") != null //24-11-2020 for eventresults included contains func //node.SelectSingleNode(".//div[@class='tsp-view r-iDNua10DBk4I']") != null
                ...
                || node.SelectSingleNode(".//div[@class='imso-ml-c PZPZlf']|.//div[@class='RRXMad']|.//div[@jsname='GDPwke']|.//div[@jscontroller='WoVPie']") != null//07-05-2024//22-09-2022 event block
                ...
                || (node.SelectSingleNode(".//div[@class='VqeGe']") != null && node.SelectSingleNode(".//div[@class='NYidgb']|.//div[@class='xKf9F']") == null))//27-02-2024//26-02-2024//20-02-2024
            {
                if ((node.SelectSingleNode(".//div[@class='Gqsa8d']") != null && node.SelectSingleNode(".//div[@class='EDblX HG5ZQb']") != null)//27-02-2024
                    ...
                    "|.//div[@class='oj7Mub eVNxY']|.//div[@class='aJegcc']|.//div[@class='nC7kNc RrlBtc']|.//div[@class='x2KtK']|.//div[contains(@class,'EyBRub')and(.//div[(@class='RyIFgf')])]") == null))//02-12-2024//25-11-2024//21-11-2024//19-11-2024//26-09-2024//24-09-2024//26-07-2024//04-07-2024//01-05-2024
                    return "Hotel";
            }
                ...
                foreach (HtmlNode nd in nodes)
                {
                    ...
                    if (ls != null)
                    {
                        foreach (HtmlNode nd1 in ls)
                        {
                            ...
                            if (spanCol == null || (spanCol != null && spanCol[0].InnerText.Equals("&nbsp;")))
