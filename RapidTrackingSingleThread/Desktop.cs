        ...
        private string ProcessOrganic(HtmlNode node)
        {
                    ...
                    foreach (HtmlNode nd in nds)
                    {
                        ...
                        if (img != null)
                        {
                            if ((Regex.IsMatch(nd.OuterHtml, "id=\"vidthumb\\d*\"") && (nd.SelectSingleNode(".//div[@class='ij69rd UHe5G']") != null || nd.SelectSingleNode(".//div[@class='ij69rd TUOsUe UHe5G']") != null)) || nd.SelectSingleNode(".//div[contains(@class,'U1TUId')]|.//div[@class='J1mWY']|.//div[contains(@class,'c8rnLc flgn0c')]|.//div[@class='Ylm8Fc']") != null)//10-06-2023//07-06-2023//02-05-2023//07-04-2022 //18-10-2021 video block selector
                            {
                                ...
                                {
                                    var a = nd.SelectSingleNode(".//div[@class='ct3b9e']/a|.//div[@class='IAZbGe']/a|.//div[@class='DhN8Cf']/a|.//div[@class='E74pWd']/a|.//div[@class='IAZbGe']/div/a");//28-07-2023//18-04-2023//11-02-2023 //07-04-2022
            ...
            else
            {
                ...
                foreach (HtmlNode n in nc)
                {
                    ...
                    {
                        var a = n.SelectSingleNode(".//div[@class='ct3b9e']/a|.//div[@class='IAZbGe']/a|.//div[@class='DhN8Cf']/a|.//div[@class='E74pWd']/a|.//div[@class='IAZbGe']/div/a");//28-07-2023//18-04-2023//13-02-2023
