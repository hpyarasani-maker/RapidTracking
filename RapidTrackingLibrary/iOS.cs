...
namespace RapidTrackingLibrary
{
            ...
            try  //28-09-2020  try catch.
            {
                ...
                if (nodeCol != null)
                 ...
                 if (nodeCol == null)//20-09-2023
                    nodeCol = doc.DocumentNode.SelectNodes("//div[@id='rso']/div[@class='MjjYud']/div|//div[@id='rso']/div[@class='MjjYud']/block-component|.//div[contains(@class,'TzHB6b')]");//22-09-2023
    ...
    "|.//div[@class='DkX4ue Va3FIb EE3Upf']/a|.//div[@class='DkX4ue IBylpb Va3FIb EE3Upf lVm3ye ']/a");//08-12-2023
            if (nds != null)
            {
                s.Append("<block type=\"siteLinks\" url=\"\">");
                foreach (HtmlNode nd in nds)
        ...
        /*private string PeopleAlsoAsk(HtmlNode node)//commented 19-01-2022
       {
        ...
        public string GetBlockType(HtmlNode node)
        {
            ...
            if ((node.SelectSingleNode(".//div[contains(@class,'WlTAzf')]|.//div[contains(@class, 'tkQJMd')]") != null || node.Attributes["class"]?.Value == "WlTAzf mnr-c vk_c" || node.Attributes["class"]?.Value == "WlTAzf Ww4FFb vt6azd vk_c") && node.SelectSingleNode(".//div[@jscontroller='UjNCHf']") == null)//22-09-2023//21-07-2023//07-07-2023
