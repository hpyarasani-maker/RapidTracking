                ...
                foreach (HtmlNode node in nodeCol)
                {
                    try
                    {
                        if (node.HasClass("kp-wholepage") || node.SelectNodes(".//div[contains(@class, 'kp-wholepage')]") != null)
                        {
                            ...
                            if (nc == null)
                                nc = node.SelectNodes(".//div[@class='WvKfwe']/div|.//div[@class='WvKfwe a3spGf']/div|.//div[@class='ChlgHf']|.//div[@class='UDZeY mf8UVb']|.//div[@class='uxUO1b g0S8Ze mnr-c']"); //07-06-2020 //01-06-2020");  //15-04-2020     
