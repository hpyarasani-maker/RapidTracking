            ...
            try //28-09-2020  try catch.
            {
                ...
                {//08-02-2024
                    if (rso.SelectNodes("//div[contains(@id,'kp-wp-tab-')]") != null)
                        nodeCol = rso.SelectNodes(".//div[contains(@class,'TzHB6b cLjAic')]|.//div[contains(@class, 'TzHB6b j8lBAb') and (.//div[contains(@class, 'RPdfze mnr-c vk_c')])]|.//div[contains(@class,'g Ww4FFb')]|.//div[@class='g PmEWq']|.//div[@class='Wt5Tfe']|.//div[@class='g']/div[@class='BYM4Nd']|.//div[@class='Lv2Cle']|.//g-section-with-header[@class='yG4QQe TBC9ub']");//07-10-2024//03-10-2024//22-07-2024//20-07-2024//09-07-2024
                    else
