...
namespace RapidTrackingCloudSingleThread
{
    class iOS
    {
        ...
        private string GetAnswerCard(HtmlNode node)//07-03-2024
        {
            ...
            s.Append("<item featureTitle=\"" + SetTitle(f_title) + "\" url=\"" + (!string.IsNullOrEmpty(itemUrl) ? itemUrl : SetUrl(url)) + "\" title=\"" +//17-05-2024//22-04-2024
        ...
        private string GetTopStories(HtmlNode node)
        {
            ...
            if (nds == null) //14-09-2022 shifted from 1991 2 lines
                nds = node.SelectNodes(".//div[contains(@class,'amp_re')]/a|.//div[@class='dbsr']/a|.//div[@class='Fq8eSd']/a|.//div[@class='y1Boce']/div/a|.//div[@data-ved]/a|.//div[contains(@class,'JJJtgd')]/a");//28-07-2020   // 18-12-2019//27-07-2020
            if (nds == null)
        ...
        private string GetVideos(HtmlNode node)
        {
            ...
            if (nds == null)
                nds = node.SelectNodes(".//div[@jsname='ibnC6b']/a|.//div[@jscontroller='OmmTPc']" +
                    ...
                    "|.//div[@class='GFu7kc']/a|.//div[@class='iyrWae']/a|.//a[@class='tAAiTd']|.//div[@class='fLyK8']/a");//12-08-2024//22-07-2024//26-02-2024//21-11-2023//24-08-2023 //17-05-2022 //07-04-2022 videos item urls
            ...
            if (nds != null)   // 16-09-2019
                foreach (HtmlNode nd in nds)
                {
                    try
                    {
                        ...
                        string creator = nd.SelectSingleNode(".//div[@class='YDQ8Te Fy8FNd OSrXXb']/span[3]|.//div[@class='pDdfmc YqCW4e OSrXXb']/span[3]|.//span[@class='GbZYR OSrXXb']")?.InnerText.Trim() ?? "";//12-08-2024//22-07-2024//04-12-2023
        ...
        private string GetBlockType(HtmlNode node)
        {
                ...
                || (node.SelectSingleNode(".//div[@class='VqeGe']") != null && node.SelectSingleNode(".//div[@class='NYidgb']|.//div[@class='xKf9F']") == null))//27-02-2024//26-02-2024//20-02-2024
            {
                ...
                && (node.SelectSingleNode(".//div[@class='vDF3Oc jIrdcd']|.//div[contains(@class,'qtOtne')]|.//div[@class='YB4h9 ky4hfd']|.//div[@class='oj7Mub eVNxY']") == null))//26-07-2024//04-07-2024//01-05-2024
                    return "Hotel";
            }
            ...
            if (nd != null)
            {
                if (nd.InnerText.Trim() == "Top stories" || nd.InnerText.ToLower().Contains("noticias") || nd.InnerText.Trim() == "Notizie principali" || nd.InnerText.Trim() == "Interesting finds" //04-11-2020//16-09-2020
                    ...
                    if ((node.SelectSingleNode(".//div[@id='tscffb']") != null || node.SelectSingleNode(".//div[@class='KJDcUb']") == null)
                            && node.SelectSingleNode(".//div/a[contains(@class,'C8nzq BmP5tf')]|.//div/a[@class='rTyHce jgWGIe']") == null && node.SelectSingleNode(".//div/a[contains(@class,'cz3goc BmP5tf')]") == null//27-08-2024
