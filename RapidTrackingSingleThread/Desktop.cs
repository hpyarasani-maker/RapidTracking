        ...
        public string ProcessDocument(string seid, string keyword, HtmlDocument doc, out int count)
        {
            ...
            try //28-09-2020  try catch.
            {
                ...
                if (string.IsNullOrEmpty(ndText) || orgLinks == 0)//08-04-2020
                {
                    ...
                    if (nodeCol == null)
                        nodeCol = doc.DocumentNode.SelectNodes("//div[@class='WvKfwe a3spGf']/div|//div[@class='WvKfwe a3spGf']/g-section-with-header|//div[@class='J9WfR eqAnXb']/div"); //06-12-2020 // 15-04-2020    //01-05-2020");  // 15-04-2020//22-05-2020
                    if (nodeCol == null)
