        ...
        private string GetBlockType(HtmlNode node)
        {
                ...
                || (node.SelectSingleNode(".//div[@class='VqeGe']") != null && node.SelectSingleNode(".//div[@class='NYidgb']|.//div[@class='xKf9F']") == null))//27-02-2024//26-02-2024//20-02-2024
            {
                if ((node.SelectSingleNode(".//div[@class='Gqsa8d']") != null && node.SelectSingleNode(".//div[@class='EDblX HG5ZQb']") != null)//27-02-2024
                    || node.SelectSingleNode(".//div[@class='HOslld dutT5c']|.//div[@class='zJUuqf adDDi']") != null && (node.SelectSingleNode(".//div[@class='RyIFgf']") == null && node.SelectNodes(".//div[contains(@class,'EXH1Ce')]") != null))//30-04-2024//29-04-2024//16-03-2024//27-02-2024
                    return "Hotel";
            }
