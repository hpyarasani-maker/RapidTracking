                ...
                foreach (HtmlNode node in nodeCol)
                {
                    try
                    {
                        if (node.HasClass("kp-wholepage") || node.SelectNodes(".//div[contains(@class, 'kp-wholepage')]") != null)
                        {
                            ...
                            if (nc == null)
                                nc = node.SelectNodes(".//div[@class='WvKfwe']/div|.//div[@class='WvKfwe a3spGf']/div|.//div[@class='ChlgHf']|.//div[@class='UDZeY mf8UVb']|.//div[@class='UDZeY']|.//div[@class='a3spGf WvKfwe']/div"); //18-0-2020 //17-06-2020 answer card  //01-06-2020");  //15-04-2020
                            if (nc == null)
