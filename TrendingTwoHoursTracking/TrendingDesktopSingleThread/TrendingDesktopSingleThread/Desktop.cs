    ...
    public class Desktop
    {
        ...
        private string ProcessOrganic(HtmlNode node)
        {
                ...
                || node.SelectNodes(".//div[@class='g tF2Cxc']|.//div[@class='g dFd2Tb']") != null) //24-08-2021 video block //01-06-2021
            {
                ...
                if (nds == null)
                    nds = node.SelectNodes(".//div[contains(@class,'dFd2Tb')]"); //24-08-2021 video block
                    ...
                    foreach (HtmlNode nd in nds)
                    {
                        ...
                        if (img != null)
                        {
                            if ((Regex.IsMatch(nd.OuterHtml, "id=\"vidthumb\\d*\"") && (nd.SelectSingleNode(".//div[@class='ij69rd UHe5G']") != null || nd.SelectSingleNode(".//div[@class='ij69rd TUOsUe UHe5G']") != null)) || nd.SelectSingleNode(".//div[contains(@class,'U1TUId')]") != null) //18-10-2021 video block selector
                            {
                                ...
                                {
                                    var a = nd.SelectSingleNode(".//div[@class='ct3b9e']/a");
        ...
        private string GetBlockType(HtmlNode node)
        {
                ...
                || node.SelectSingleNode(".//div[@class='M0XuFe mnr-c vk_c']") != null)//23-12-2021
            {
                if (node.SelectSingleNode(".//div[@class='BET1rd']|.//div[@class='EfDVh wDYxhc NFQFxe']") == null && node.SelectSingleNode(".//div[@class='tpa-cc']") == null //23-12-2021 //21-08-2021 //25-09-2020
                    ...
                    || node.SelectSingleNode(".//div[@class='nmVgI3FLyE0__answer']") != null) //23-03-2022
            ...
            if (nd != null && node.SelectSingleNode(".//div[@class='q6PGbe']") == null && node.SelectSingleNode(".//div[@class='l44Vof']") == null && node.SelectSingleNode(".//div[@class='P9Jfrb']") == null && node.SelectSingleNode(".//div[@class='LnbJhc']") == null) //18-03-2022
            ...
            if (nd == null)
                nd = node.SelectSingleNode(".//div[@class='xERobd']|.//div[@class='H93uF']|.//div[@class='CH6Bmd']");//05-03-2022//22-01-2022  //changed on 26-06-2019
            if (nd == null)
