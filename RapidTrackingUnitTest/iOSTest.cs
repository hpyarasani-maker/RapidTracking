...
namespace RapidTrackingUnitTest
{
    ...
    public class iOSTest
    {
        ...
        public void TestiOSAnswerCardBlockExisted()
        {
            ...
            string path = startupPath + @"\test\answercard.txt";
            doc.Load(path);
        ...
        public void TestiOSTopStoriesBlockExisted()
        {
            ...
            string path = startupPath + @"\test\ts\tsblock1.txt";
            doc.Load(path);
            var node = doc.DocumentNode.SelectSingleNode("/");
        ...
        public void TestiOSTopStoriesBlockExisted2()
        {
            ...
            string path = startupPath + @"\test\ts\tsblock2.txt";
            doc.Load(path);
            var node = doc.DocumentNode.SelectSingleNode("/");
            var result = iOS.GetTopStories(node);
            Assert.AreEqual(!string.IsNullOrEmpty(result), true);
        ...
        public void TestiOSAppsBlockExisted()
        {
            ...
            string path = startupPath + @"\test\apps\appsblock1.txt";
            doc.Load(path);
            var node = doc.DocumentNode.SelectSingleNode("/");
        ...
        public void TestiOSAppsBlockExisted2()
        {
            ...
            string path = startupPath + @"\test\apps\appsblock2.txt";
            doc.Load(path);
            var node = doc.DocumentNode.SelectSingleNode("/");
            var result = iOS.GetApps(node);
            Assert.AreEqual(!string.IsNullOrEmpty(result), true);
        ...
        public void TestiOSCarouselBlockExisted()
        {
            ...
            string path = startupPath + @"\test\carousel\carousel1.txt";
            doc.Load(path);
            var node = doc.DocumentNode.SelectSingleNode("/");
        ...
        public void TestiOSCarouselBlockExisted2()
        {
            ...
            string path = startupPath + @"\test\carousel\carousel2.txt";
            doc.Load(path);
            var node = doc.DocumentNode.SelectSingleNode("/");
            var result = iOS.GetCarousel(node);
            Assert.AreEqual(!string.IsNullOrEmpty(result), true);
        ...
        public void TestiOSTwitterCardsBlockExisted()
        {
            ...
            string path = startupPath + @"\test\twittercard.txt";
            doc.Load(path);
            var node = doc.DocumentNode.SelectSingleNode("/");
        ...
        public void TestiOSPeopleAlsoAskBlockExisted()
        {
            ...
            string path = startupPath + @"\test\peoplealsoask.txt";
            doc.Load(path);
            var node = doc.DocumentNode.SelectSingleNode("/");
        ...
        public void TestiOSImagesBlockExisted()
        {
            ...
            string path = startupPath + @"\test\images.txt";
            doc.Load(path);
            var node = doc.DocumentNode.SelectSingleNode("/");
        ...
        public void TestiOSVideosBlockExisted()
        {
            ...
            string path = startupPath + @"\test\videos\videosblock1.txt";
            doc.Load(path);
            var node = doc.DocumentNode.SelectSingleNode("/");
        ...
        public void TestiOSSiteLinksBlockExisted()
        {
            var iOS = new iOS();
            HtmlDocument doc = new HtmlDocument();
            string path = startupPath + @"\test\sitelinks.txt";
            doc.Load(path);
            var node = doc.DocumentNode.SelectSingleNode("/");
        ...
        public void TestiOSKnowledgeGraphExisted()
        {
            var iOS = new iOS();
            HtmlDocument doc = new HtmlDocument();
            string path = startupPath + @"\test\knowledgegraph.txt";
            doc.Load(path);
            var node = doc.DocumentNode.SelectSingleNode("/");
        ...
        public void TestiOSJobsBlockExisted()
        {
            var iOS = new iOS();
            HtmlDocument doc = new HtmlDocument();
            string path = startupPath + @"\test\jobs.txt";
            doc.Load(path);
            var node = doc.DocumentNode.SelectSingleNode("/");
        ...
        public void TestiOSTopStuffProductListedAdsExisted()
        {
            var iOS = new iOS();
            HtmlDocument doc = new HtmlDocument();
            string path = startupPath + @"\test\tsplads.txt";
            doc.Load(path);
        ...
        public void TestiOSTopStuffAdwordsExisted()
        {
            var iOS = new iOS();
            HtmlDocument doc = new HtmlDocument();
            string path = startupPath + @"\test\tsadwords.txt";
            doc.Load(path);
            var result = iOS.GetTopStuff(doc);
            Assert.AreEqual(!string.IsNullOrEmpty(result), true);
        }
        ...
        {
            var html = startupPath + @"\test\htmlsrc.html";
            var ios = new iOS();
        ...
        public void TestiOSVideoCardBlockExisted()
        {
            var iOS = new iOS();
            HtmlDocument doc = new HtmlDocument();
            string path = startupPath + @"\test\videocard.txt";
            doc.Load(path);
            var node = doc.DocumentNode.SelectSingleNode("/");
        ...
        public void TestiOSIsBlockNotExisted()
        {
            var iOS = new iOS();
            HtmlDocument doc = new HtmlDocument();
            string path = startupPath + @"\test\classiclink.txt";
            doc.Load(path);
            var node = doc.DocumentNode.SelectSingleNode("/");
            var result = iOS.IsBlock(node);
        ...
        public void TestiOSProductListedAdsBlockExisted()
        {
            var iOS = new iOS();
            HtmlDocument doc = new HtmlDocument();
            string path = startupPath + @"\test\productlistedads.txt";
            doc.Load(path);
            var node = doc.DocumentNode.SelectSingleNode("/");
        ...
        public void TestiOSSiteLinksBlock2Existed()
        {
            var iOS = new iOS();
            HtmlDocument doc = new HtmlDocument();
            string path = startupPath + @"\test\sitelinks1.txt";
            doc.Load(path);
            var node = doc.DocumentNode.SelectSingleNode("/");
            var result = iOS.GetSiteLinks(node);
            Assert.AreEqual(!string.IsNullOrEmpty(result), true);
        ...
        public void TestiOSTSBlockTypeExisted()
        {
            var ios = new iOS();
            HtmlDocument doc = new HtmlDocument();
            string path = startupPath + @"\test\topstories.txt";
            doc.Load(path);
            var node = doc.DocumentNode.SelectSingleNode("/");
            var result = ios.ProcessBlock(node);
            Assert.AreEqual(!string.IsNullOrEmpty(result), true);
        ...
        public void TestiOSVideosBlockTypeExisted()
        {
            var ios = new iOS();
            HtmlDocument doc = new HtmlDocument();
            string path = startupPath + @"\test\videos.txt";
            doc.Load(path);
            var node = doc.DocumentNode.SelectSingleNode("/");
            var result = ios.ProcessBlock(node);
            Assert.AreEqual(!string.IsNullOrEmpty(result), true);
        ...
        public void TestiOSGetBottomStuffProductListedAdsExisted()
        {
            var ios = new iOS();
            HtmlDocument doc = new HtmlDocument();
            string path = startupPath + @"\test\bsplads1.txt";
            doc.Load(path);
            var node = doc.DocumentNode.SelectSingleNode("/");
        ...
        public void TestiOSBottomStuffAdwordsBlockExisted1()
        {
            var ios = new iOS();
            HtmlDocument doc = new HtmlDocument();
            string path = startupPath + @"\test\BottomStuffAdwords1.txt";
            doc.Load(path);
            var result = ios.GetBottomStuff(doc);
            Assert.AreEqual(!string.IsNullOrEmpty(result), true);
        }
        ...
        public void TestiOSBottomStuffAdwordsBlockExisted2()
        {
            var ios = new iOS();
            HtmlDocument doc = new HtmlDocument();
            string path = startupPath + @"\test\BottomStuffAdwords2.txt";
            doc.Load(path);
            var result = ios.GetBottomStuff(doc);
            Assert.AreEqual(!string.IsNullOrEmpty(result), true);
        }
        ...
        public void TestiOSBottomStuffAdwordsBlockExisted3()
        {
            var ios = new iOS();
            HtmlDocument doc = new HtmlDocument();
            string path = startupPath + @"\test\BottomStuffAdwords3.txt";
            doc.Load(path);
            var result = ios.GetBottomStuff(doc);
            Assert.AreEqual(!string.IsNullOrEmpty(result), true);
        }
        ...
        public void TestiOSTopStuffAdwordsBlockExisted1()
        {
            var ios = new iOS();
            HtmlDocument doc = new HtmlDocument();
            string path = startupPath + @"\test\TopStuffAdwords1.txt";
            doc.Load(path);
            var result = ios.GetTopStuff(doc);
            Assert.AreEqual(!string.IsNullOrEmpty(result), true);
        }
        ...
        public void TestiOSTopStuffAdwordsBlockExisted2()
        {
            var ios = new iOS();
            HtmlDocument doc = new HtmlDocument();
            string path = startupPath + @"\test\TopStuffAdwords2.txt";
            doc.Load(path);
            var result = ios.GetTopStuff(doc);
            Assert.AreEqual(!string.IsNullOrEmpty(result), true);
        }
        ...
        public void TestiOSTopStuffAdwordsBlockExisted3()
        {
            var ios = new iOS();
            HtmlDocument doc = new HtmlDocument();
            string path = startupPath + @"\test\TopStuffAdwords3.txt";
            doc.Load(path);
            var result = ios.GetTopStuff(doc);
            Assert.AreEqual(!string.IsNullOrEmpty(result), true);
        }
        ...
        public void TestiOSTopStuffAnswercardBlockExisted()
        {
            var ios = new iOS();
            HtmlDocument doc = new HtmlDocument();
            string path = startupPath + @"\test\TopStuffAnswercard.txt";
            doc.Load(path);
            var result = ios.GetTopStuff(doc);
            Assert.AreEqual(!string.IsNullOrEmpty(result), true);
        }
        ...
        public void TestiOSImagesBlockExisted2()
        {
            var iOS = new iOS();
            HtmlDocument doc = new HtmlDocument();
            string path = startupPath + @"\test\images2.txt";
            doc.Load(path);
            var node = doc.DocumentNode.SelectSingleNode("/");
            var result = iOS.GetImages(node);
            Assert.AreEqual(!string.IsNullOrEmpty(result), true);
        ...
        public void TestiOSCarouselBlockExisted3()
        {
            var iOS = new iOS();
            HtmlDocument doc = new HtmlDocument();
            string path = startupPath + @"\test\carousel\carousel3.txt";
            doc.Load(path);
            var node = doc.DocumentNode.SelectSingleNode("/");
            var result = iOS.GetCarousel(node);
            Assert.AreEqual(!string.IsNullOrEmpty(result), true);
        ...
        public void TestiOSTopStoriesBlockExisted3()
        {
            ...
            string path = startupPath + @"\test\ts\tsblock3.txt";
            doc.Load(path);
            var node = doc.DocumentNode.SelectSingleNode("/");
            var result = iOS.GetTopStories(node);
            Assert.AreEqual(!string.IsNullOrEmpty(result), true);
        ...
        public void TestiOSMapsBlockTypeExisted()
        {
            var ios = new iOS();
            HtmlDocument doc = new HtmlDocument();
            string path = startupPath + @"\test\maps.txt";
            doc.Load(path);
            var node = doc.DocumentNode.SelectSingleNode("/");
            var result = ios.ProcessBlock(node);
            Assert.AreEqual(!string.IsNullOrEmpty(result), true);
        ...
        public void TestiOSvideoBlock1Existed()
        {
            var iOS = new iOS();
            HtmlDocument doc = new HtmlDocument();
            string path = startupPath + @"\test\videoblock1.txt";
            doc.Load(path);
            var node = doc.DocumentNode.SelectSingleNode("/");
            var result = iOS.ProcessNode(node);
            Assert.AreEqual(!string.IsNullOrEmpty(result), true);
        ...
        public void TestiOSvideoBlock2Existed()
        {
            var iOS = new iOS();
            HtmlDocument doc = new HtmlDocument();
            string path = startupPath + @"\test\videoblock2.txt";
            doc.Load(path);
            var node = doc.DocumentNode.SelectSingleNode("/");
            var result = iOS.ProcessNode(node);
            Assert.AreEqual(!string.IsNullOrEmpty(result), true);
        ...
        public void TestiOSTopStuffknowledgeGraphExisted()
        {
            var iOS = new iOS();
            HtmlDocument doc = new HtmlDocument();
            string path = startupPath + @"\test\tsknowledgeGraph.txt";
            doc.Load(path);
            var result = iOS.GetTopStuff(doc);
            Assert.AreEqual(!string.IsNullOrEmpty(result), true);
        }//end 30-08-2021
        ...
        public void TestiOSProcessDocument()
        {
            var iOS = new iOS();
            HtmlDocument doc = new HtmlDocument();
            string path = startupPath + @"\test\htmlsrc.html";
            doc.Load(path);
        ...
        public void TestiOSProcessDocument1()
        {
            var iOS = new iOS();
            HtmlDocument doc = new HtmlDocument();
            string path = startupPath + @"\test\htmlsrc1.html";
            doc.Load(path);
            var result = iOS.ProcessDocument(seid, keyword, doc, out int cnt);
            Assert.AreEqual(!string.IsNullOrEmpty(result) && cnt > 0, true);
        }
        ...
        public void TestiOSSupportMethods()
        {
            var iOS = new iOS();
            HtmlDocument doc = new HtmlDocument();
            string path = startupPath + @"\test\src.txt";
            doc.Load(path);
        ...
        public void TestiOSSupportMethods2()
        {
            var iOS = new iOS();
            HtmlDocument doc = new HtmlDocument();
            string path = startupPath + @"\test\src1.txt";
            doc.Load(path);
            SupportMethods.iOsHtml = doc.DocumentNode.OuterHtml;
            var node = doc.DocumentNode.SelectSingleNode("/");
            var res = iOS.ProcessDocument(seid, keyword, doc, out int cnt);
        ...
        public void TestiOSSupportMethods3()
        {
            var iOS = new iOS();
            HtmlDocument doc = new HtmlDocument();
            string path = startupPath + @"\test\src2.txt";
            doc.Load(path);
            SupportMethods.iOsHtml = doc.DocumentNode.OuterHtml;
            var node = doc.DocumentNode.SelectSingleNode("/");
            var res = iOS.ProcessDocument(seid, keyword, doc, out int cnt);
        ...
        public void TestiOSSupportMethods4()
        {
            var iOS = new iOS();
            HtmlDocument doc = new HtmlDocument();
            string path = startupPath + @"\test\htmlsrc2.html";
            doc.Load(path);
            SupportMethods.iOsHtml = doc.DocumentNode.OuterHtml;
            var node = doc.DocumentNode.SelectSingleNode("/");
            var res = iOS.ProcessDocument(seid, keyword, doc, out int cnt);
        ...
        public void TestiOSTopStuffAppsBlockExisted()
        {
            var ios = new iOS();
            HtmlDocument doc = new HtmlDocument();
            string path = startupPath + @"\test\tsapps.txt";
            doc.Load(path);
            var result = ios.GetTopStuff(doc);
            Assert.AreEqual(!string.IsNullOrEmpty(result), true);
        }//end 20-10-2021
