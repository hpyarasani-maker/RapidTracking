    ...
    public class Desktop
    {
        ...
        public string ProcessDocument(string seid, string keyword, HtmlDocument doc, out int count)
        {
            ...
            if (string.IsNullOrEmpty(ndText) || orgLinks == 0)//08-04-2020
            {
                ...
                if (nodeCol == null)
                    nodeCol = doc.DocumentNode.SelectNodes(".//div[@class='WvKfwe']/div|//div[@class='WvKfwe a3spGf']/div|//div[contains(@class,'J9WfR')]/div");//05-12-2020");//05-12-2020//03-12-2020  //05-12-2020
                if (nodeCol == null)
