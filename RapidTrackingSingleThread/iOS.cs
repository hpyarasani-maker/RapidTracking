        ...
        private bool IsBlock(HtmlNode node)
        {
            ...
            if (nd != null)
            {
                if (nd.InnerText.Trim() == "Top stories" || nd.InnerText.ToLower().Contains("noticias") || nd.InnerText.Trim() == "Notizie principali" || nd.InnerText.Trim() == "Interesting finds" //04-11-2020//16-09-2020
                    ...
                    if ((node.SelectSingleNode(".//div[@id='tscffb']") != null || node.SelectSingleNode(".//div[@class='KJDcUb']") == null) && node.SelectSingleNode(".//div/a[@class='C8nzq BmP5tf']") == null && node.SelectSingleNode(".//div/a[@class='C8nzq BmP5tf amp_r']") == null) //25-05-2021 //04-01-2021 video block
                        return true;
