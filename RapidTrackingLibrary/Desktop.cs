    ...
    public class Desktop
    {
        ...
        public string ProcessDocument(string seid, string keyword, HtmlDocument doc, out int count)
        {
            ...
            try //28-09-2020  try catch.
            {
                ...
                if (nodeCol == null)
                    nodeCol = doc.DocumentNode.SelectNodes("//div[@id='rso']/g-section-with-header|//div[@class='Hpbsqe']|//div[@id='Odp5De']|//div[contains(@class,'TzHB6b cLjAic')]|//div[contains(@id, 'arc-srp')]/div/div[@class='MjjYud']|//div[contains(@id, 'arc-srp')]/div/div/div[@class='MjjYud']|//div[@id='rso']/div[@class='MjjYud']");//01-11-2023//30-10-2023
                ...
                if (nodeCol == null || nodeCol.Count <= 4)//02-05-2023//21-04-2023
                    nodeCol = doc.DocumentNode.SelectNodes(".//div[@class='WvKfwe a3spGf']/div|.//div[contains(@class, 'TzHB6b cLjAic')]") ?? nodeCol;//31-10-2023//30-10-2023//22-09-2023//21-09-2023 //19-09-2023
                if (nodeCol == null || (nodeCol.Count >= 1 && nodeCol.Count <= 3))//27-10-2023//25-07-2022
                    nodeCol = doc.DocumentNode.SelectNodes(".//div[contains(@class,'WvKfwe')]/div|.//div[@class='UDZeY OTFaAf']/div|//div[@class='MjjYud']") ?? nodeCol;//31-10-2023//16-12-2022//17-08-2022
        ...
        public string ProcessOrganic(HtmlNode node)
        {
            ...
            else
            {
                ...
                {
                    nc = node.SelectNodes(".//div[@class='g']|.//div[contains(@class,'g Ww4FFb')]|.//div[@class='g eejeod up9jud']|.//div[contains(@class,'g dFd2Tb')]|.//div[contains(@class,'g ZYT4Gf')]");//07-08-2023//26-04-2023//12-10-2022
                ...
                foreach (HtmlNode n in nc)
                {
                    ...
                    {
                        var a = n.SelectSingleNode(".//div[@class='ct3b9e']/a|.//div[@class='IAZbGe']/a|.//div[@class='DhN8Cf']/a|.//div[@class='E74pWd']/a");//18-04-2023
      ...
      /*private string PeopleAlsoAsk(HtmlNode node) //commented 19-01-2022
        ...
        public string GetFlights(HtmlNode node)//29-06-2023
        {
            StringBuilder s = new StringBuilder();
            ...
            if (nds != null)
            {
                foreach (HtmlNode nd in nds)
                {
                    try
                    {
                        ...
                        string hours = nd.SelectSingleNode(".//span[@class='sRcB8']|.//div[@class='QTPlac']/span[3]")?.InnerText.Trim() ?? "0h 0m";
                        string connecting = nd.SelectSingleNode(".//span[@class='u85UCd']|.//div[@class='QTPlac']/span[1]")?.InnerText.Trim() ?? "";
                        string price = nd.SelectSingleNode(".//span[@class='xqqLDd']|.//span[@class='cirEce']|.//div[@class='n22NNe']")?.InnerText.Trim() ?? "0";
        ...
        public bool IsBlock(HtmlNode node)
        {
            ...
            if (bVal == true)//2019-09-11
            {
                try
                {
                    if (node.SelectSingleNode(".//div[@class='Brgz0 tw-res']|.//div[@class='k9uN1c kfn9hb']|.//div[@class='baPFxb g kSMK2']") != null) return true;//26-10-2023//04-01-2023//16-12-2022
