    ...
    public partial class Form1 : Form
    {
        ...
        private async Task StartProcess_1()
        {
            while (true)
            {
                ...
                string kwQry = "Tracking_DB_Keywords_SEID_102_AIO_Req '" + myDate + "',1";
        ...
        private async Task StartProcess_2()
        {
            while (true)
            {
                ...
                string kwQry = "Tracking_DB_Keywords_SEID_102_AIO_Req '" + myDate + "',2";
        ...
        private async Task StartProcess_3()
        {
            while (true)
            {
                ...
                string kwQry = "Tracking_DB_Keywords_SEID_102_AIO_Req '" + myDate + "',3";
