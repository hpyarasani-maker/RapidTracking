            ...
            try //28-09-2020  try catch.
            {
                ...
                {//08-02-2024
                    if (rso.SelectNodes("//div[contains(@id,'kp-wp-tab-')]") != null)
                        ...
                        "|.//div[@class='wHYlTd Ww4FFb vt6azd tF2Cxc asEBEc']|.//div[contains(@class,'PmEWq wHYlTd')]|.//div[@id='knowledge-finance-wholepage__entity-summary']");//03-04-2025//21-03-2025//18-02-2025//14-02-2025//31-12-2024//09-10-2024t6azd tF2Cxc asEBEc']|.//div[contains(@class,'PmEWq wHYlTd')]");//21-03-2025//18-02-2025//14-02-2025//31-12-2024//09-10-2024
                    else
