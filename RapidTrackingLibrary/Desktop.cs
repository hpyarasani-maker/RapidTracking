        ...
        public string ProcessDocument(string seid, string keyword, HtmlDocument doc, out int count)
        {
            ...
            try //28-09-2020  try catch.
            {
                ...
                if (string.IsNullOrEmpty(ndText) || orgLinks == 0)//08-04-2020
                {
                    ...
                    if (nodeCol == null)
                        nodeCol = doc.DocumentNode.SelectNodes(".//div[contains(@class,'WvKfwe')]/div|.//div[contains(@class,'WvKfwe')]/g-section-with-header|.//div[@class='UDZeY OTFaAf']|.//div[@class='MjjYud']");//25-11-2022//09-12-2020
                    if (nodeCol != null) //11-08-2022
                    foreach (HtmlNode node in nodeCol)
                    {
                        try
