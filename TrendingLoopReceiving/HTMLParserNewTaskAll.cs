    ...
    class HTMLParserNewTaskAll
    {
        ...
        public HTMLParserNewTaskAll()
        {
            ...
            Thread t1 = new Thread(new ThreadStart(StartProcess))
            {
                //Name = "All_1"
                //Name = "twd_1"
                Name = "CommaKeywords_Loop_1"
                //Name = "All_102_DC_5_WOC"
                //Name = "All_15"
                //Name = "NewSEIDs_3"
                // Name = "Mobile_102_10"
                //Name = "NewCommaKeywords_2"
                //Name = "ODesktop_20"
                //Name = "NewMobile_4"
                //Name = "NewComma"
        ...
        private async void StartProcess()
        {
            ...
            //string url = "https://seresults.azurewebsites.net/api/callbackus1desktop/";     // 1   CommaKwds Desktop
            //string url = "https://seresults.azurewebsites.net/api/callbackus102mobile/";      // 102 CommaKwds Mobile
            //string url = "https://previous.azurewebsites.net/api/callbackuk58desktop/";       // 58 sending for previous date                                                                                       
            Uri ul = new Uri(url);
            ...
            try
            {
                using (SqlConnection con = new SqlConnection(await StrConn()))
                {
                    ...
                    using (SqlCommand comm = con.CreateCommand())
                    {
                        ...
                        comm.Parameters.Add("Received", SqlDbType.VarChar).Value = "Normal Loop GT0 Receive ALL"; //14-04-2025
