        ...
        public string ProcessDocument(string seid, string keyword, HtmlDocument doc, out int count)
        {
            ...
            try //28-09-2020  try catch.
            {
                ...
                foreach (HtmlNode node in nodeCol)
                {
                    ...
                    if (node.HasClass("TzHB6b") && node.SelectSingleNode(".//div[contains(@class,'g Ww4FFb')]|.//div[@class='g PmEWq']|.//div[@class='Wt5Tfe']|.//div[@class='g']/div[@class='BYM4Nd']|.//div[@class='Lv2Cle']|.//g-section-with-header[contains(@class,'yG4QQe TBC9ub')]|.//div[@class='uVMCKf']|.//div[@class='vtSz8d']|.//div[@class='wHYlTd Ww4FFb vt6azd tF2Cxc asEBEc']") != null)//21-03-2025//14-02-2025//31-12-2024//09-10-2024
                    {
                        continue;
                    }//09-10-2024
                    try
