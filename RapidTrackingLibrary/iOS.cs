    ...
    public class iOS
    {
        ...
        /*private string PeopleAlsoAsk(HtmlNode node)//commented 19-01-2022
       {
        ...
        public string GetBlockType(HtmlNode node)
        {
            ...
            {
                if ((node.SelectSingleNode(".//div[@class='Gqsa8d']") != null && (node.SelectSingleNode(".//div[@class='EDblX HG5ZQb']") != null && node.SelectSingleNode(".//div[@class='RyIFgf']") == null))//30-04-2024//27-02-2024//27-02-2024
