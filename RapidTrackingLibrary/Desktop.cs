    ...
    public class Desktop
    {
        ...
        public string ProcessDocument(string seid, string keyword, HtmlDocument doc, out int count)
        {
            ...
            try //28-09-2020  try catch.
            {
                ...
                if (nodeCol == null || (nodeCol.Count <= 1) || (rso.SelectNodes(".//div[@class='JCZQSb']") != null && !rso.SelectNodes(".//div[@class='JCZQSb']")[0].Ancestors("div").Any(n => n.Id == "rhs")))//29-07-2025//16-07-2025
                ...
                if (nodeCol == null || (nodeCol.Count >= 1 && nodeCol.Count <= 12))//29-07-2025//15-07-2025//09-02-2024
                {//08-02-2024
                    if (rso.SelectNodes("//div[contains(@id,'kp-wp-tab-')]") != null)
                        nodeCol = rso.SelectNodes(".//div[contains(@class,'TzHB6b cLjAic')]|.//div[contains(@class,'TzHB6b j8lBAb p7kDMc')]|.//div[contains(@class,'g Ww4FFb')]|.//div[@class='g PmEWq']" +
                            ...
                            "|.//div[@class='wHYlTd Ww4FFb vt6azd tF2Cxc asEBEc']|.//div[contains(@class,'PmEWq wHYlTd')]|.//div[@id='knowledge-finance-wholepage__entity-summary']|.//div[@jscontroller='hKbgK']");//24-07-2025//03-04-2025//21-03-2025//18-02-2025//14-02-2025//31-12-2024//09-10-2024
                    else
                ...
                foreach (HtmlNode node in nodeCol)
                {
                    ...
                    //if (node.HasClass("TzHB6b") && node.SelectSingleNode(".//div[contains(@class,'g Ww4FFb')]|.//div[@class='wHYlTd Ww4FFb vt6azd tF2Cxc asEBEc']|.//div[contains(@class,'PmEWq wHYlTd')]|.//div[contains(@class,'g PmEWq')]|.//div[@class='Wt5Tfe']|.//div[@class='g']/div[@class='BYM4Nd']|.//div[@class='Lv2Cle']|.//g-section-with-header[contains(@class,'yG4QQe TBC9ub')]|.//div[@class='uVMCKf']|.//div[@class='vtSz8d']") != null)//21-03-2024//31-12-2024//09-10-2024 //video block and avoid duplicate Topstories
        ...
        public string GetGoogleHotels(HtmlNode rcNode)//18-01-2023 Google Hotels from KP block
        {
            StringBuilder s = new StringBuilder();
        ...
        public string GetPopularProducts(HtmlNode node)
        {
            StringBuilder s = new StringBuilder();
                ...
                foreach (HtmlNode nd in nodes)
                {
                    ...
                    try
                    {
                        ...
                        if (link != null)
                        {
                            ...
                            price = link.SelectSingleNode(".//div[@class='ldGAMe']|.//div[@class='z235y jAPStb']|.//div[@class='s1bFpb']|.//div[contains(@class, 'VQgkpe')]/span[1]|.//div[@class='FG68Ac']|.//div[contains(@class,'zxVpA')]/span[1]")?.InnerText ?? "";//02-07-2025//21-04-2023
                        ...
                        if (img != null)
                        {
                            ...
                            else if (orgLinks < 100)
                            {
                                ...
                                if (n == null)//18-04-2023
                                    n = nd.SelectSingleNode(".//div[@class='E74pWd']/a|.//g-link[@class='WYrxZc']/a");//05-12-2023//18-04-2023
        ...
        public string GetAdwords(HtmlNode node)//27-12-2024 missing adwords block middle page
        {
            StringBuilder s = new StringBuilder();
        ...
        public string GetPeopleAlsoSearch(HtmlNode node)//14-10-2024
        {
            ...
            if (nd == null && node.Attributes["class"]?.Value == "oIk2Cb")//03-04-2025
        ...
        public string GetDataset(HtmlNode node)//11-06-2024 DataSet Block
        {
            StringBuilder s = new StringBuilder();
      ...
      /*private string PeopleAlsoAsk(HtmlNode node) //commented 19-01-2022
        ...
        public string GetFlights(HtmlNode node)//29-06-2023//15-11-2024 updated method and removed url and title attributes from blocktype and item elements
        {
            StringBuilder s = new StringBuilder();
            ...
            {
                dest = node.SelectSingleNode(".//div[@class='cj1ht QkBAO oYQBg']");//02-07-2025
                if (dest == null)//02-07-2025
            ...
            if (nds == null)//02-07-2025
                nds = node.SelectNodes(".//div[@class='qR29te']/div");//02-07-2025
            if (nds != null)
            {
                foreach (HtmlNode nd in nds)
                {
        ...
        public string GetHotels(HtmlNode node)//24-03-2022 new element Maps//15-11-2024 removed url attribute from both blocktype and item elements
        {
            StringBuilder s = new StringBuilder();
        ...
        public string GetBlockType(HtmlNode node)
        {
            ...
            if (nd != null && nd.SelectNodes(".//div[@class='MxQnIc']") == null && node.SelectSingleNode(".//div[@class='XNfAUb']|.//h1[contains(@class, 'bNg8Rb')]" +
             "|.//div[@class='ad5fcd']|.//div[contains(@class,'vmod')]|.//div[@class='HJSKzf']|.//div[contains(@class,'wDYxhc')]|.//div[@class='OcpZAb']/w-answer|.//div[@class='e2BEnf q8U8x']|.//miniapps-card-header|.//g-expandable-container[@class='LHMFHf BbXTb']") == null)//31-07-2025//19-06-2025//06-06-2025//13-05-2025//05-05-2025//22-04-2025//21-02-2025//27-12-2024//19-08-2024//30-06-2023
            ...
            nd = node.SelectSingleNode(".//div/h1[contains(@class, 'bNg8Rb')]|.//h1[contains(@class, 'bNg8Rb')]|.//div/span[contains(@class, 'stGWLc')]");//03-04-2025//27-12-2024
            ...
            if (bVal == true)//2019-09-11
            {
                try
                {
                    ...
                    if (node.SelectSingleNode(".//div[@class='twQ0Be']|.//div[@jsname='N760b']|.//div[@jsname='wRSfy']|.//div[contains(@class,'e2BEnf U7izfe')]" + //03-11-2023//05-12-2022//26-09-2022//13-08-2022 maps//08-03-2022//07-03-2022//28-12-2021//10-12-2021//09-12-2021 //08-12-2021 PAlsoB   //30-08-2021 video card
                       ...
                       "|.//g-section-with-header[contains(@class,'yG4QQe TBC9ub')]|.//div[contains(@class,'knowledge-finance')]|.//div[@class='Lv2Cle']|.//div[@class='o8ebK']|.//g-card[@class='T98FId']") != null) return true;//30-07-2025
