...
namespace RapidTrackingResSingleThread
{
    public class SearchParams
    {
        public static IList<SearchProperties> searches = new List<SearchProperties>()
        {
            ...
            {
                seid=1, domain="com", country="US", locale="en-us", uule="w+CAIQICINVW5pdGVkIFN0YXRlcw==",device="desktop_chrome"
            },
            new SearchProperties()
            {
                seid=58, domain="co.uk", country="UK", locale="en-gb",uule="w+CAIQICIOVW5pdGVkIEtpbmdkb20=",device="desktop_chrome"
            },
            new SearchProperties()
            {
