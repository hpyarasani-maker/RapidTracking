    ...
    public class Desktop
    {
        ...
        private string GetBottomStuff(HtmlDocument doc)
        {
            ...
            if (colb != null)
            {
                ...
                {
                    HtmlNode n = nd.SelectSingleNode(".//h3/a[2]|.//div[@class='ad_cclk']/a[2]|.//div[@class='d5oMvf']/a|.//div[@class='v5yQqb']/a");//12-11-2021 //27-06-2020
                    if (n != null)
                    {
            ...
            if (colt != null)
            {
                ...
                if (col != null) //return s.ToString();  //20-01-2020
                {
                    ...
                    foreach (HtmlNode nd in col)
                    {
                        ...
                        HtmlNode n = nd.SelectSingleNode(".//div[@class='ad_cclk']/a[2]|.//div[contains(@class,'d5oMvf')]/a|.//div[@class='v5yQqb']/a");//12-11-2021 //29-08-2020 included contains fucntions //23-07-2020 included missing item urls selectors
                        if (n != null)
                        {
                             //25-08-2020
                            try  //28-09-2020  try catch.
