            ...
            if (nodes != null)
            {
                foreach (HtmlNode nd in nodes)
                {
                    ...
                    try
                    {
                        ...
                        if (link == null)//06-03-2023
                            link = nd.SelectSingleNode(".//div[contains(@class,'wTrwWd')]");//06-03-2023
                        if (link != null)
                        {
                            url = link.Attributes["href"]?.Value ?? ""; //24-01-2023
                            title = link.SelectSingleNode(".//div[@class='vuR1ld']|.//div[@class='wEN0R']|.//div[contains(@class,'vYe7gd')]|.//div[@class='SsM98d RmEs5b']")?.InnerText ?? ""; //06-03-2023
                            price = link.SelectSingleNode(".//div[@class='ldGAMe']|.//div[@class='z235y jAPStb']|.//div[@class='s1bFpb']|.//div[contains(@class, 'VQgkpe')]/span[1]")?.InnerText ?? "";//06-03-2023
                            name = link.SelectSingleNode(".//div[@class='DNnNed nbhTP']/span[@class='Dt4hCc']|.//div[@class='ix5OZc']|.//div[@class='pMiHCf']|.//div[@class='n7emVc']")?.InnerText ?? "";//06-03-2023
                        }
