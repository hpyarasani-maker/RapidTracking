        ...
        public bool IsBlock(HtmlNode node)
        {
            ...
            if (bVal == true)//2019-09-11
            {
                try
                {
                    ...
                    if (node.SelectSingleNode(".//div[@class='twQ0Be']|.//div[@jsname='N760b']|.//div[@jsname='wRSfy']|.//div[contains(@class,'e2BEnf U7izfe')]|.//div[@jsname='A6RGif']") != null) return true;//07-03-2022//28-12-2021//09-12-2021 //08-12-2021 PAlsoB //30-08-2021 video card
