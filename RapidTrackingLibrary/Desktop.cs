    ...
    public class Desktop
    {
            ...
            try //28-09-2020  try catch.
            {
                ...
                {//08-02-2024
                    if (rso.SelectNodes("//div[contains(@id,'kp-wp-tab-')]") != null)
                        nodeCol = rso.SelectNodes(".//div[contains(@class,'TzHB6b cLjAic')]|.//div[contains(@class,'TzHB6b j8lBAb p7kDMc')]|.//div[contains(@class,'g Ww4FFb')]|.//div[@class='g PmEWq']|.//div[@class='Wt5Tfe']" +
                            "|.//div[@class='g']/div[@class='BYM4Nd']|.//div[@class='Lv2Cle']|.//g-section-with-header[contains(@class,'yG4QQe TBC9ub')]|.//div[@class='uVMCKf']|.//div[@class='vtSz8d']|.//div[@class='wHYlTd Ww4FFb vt6azd tF2Cxc asEBEc']");//18-02-2025//14-02-2025//31-12-2024//09-10-2024
                    else
                ...
                foreach (HtmlNode node in nodeCol)
                {
                    if (node.HasClass("kp-wholepage"))
                    {
                        ...
                        if (node.HasClass("TzHB6b") && node.SelectSingleNode(".//div[contains(@class,'g Ww4FFb')]|.//div[@class='g PmEWq']|.//div[@class='Wt5Tfe']|.//div[@class='g']/div[@class='BYM4Nd']|.//div[@class='Lv2Cle']|.//g-section-with-header[contains(@class,'yG4QQe TBC9ub')]|.//div[@class='uVMCKf']|.//div[@class='vtSz8d']|.//div[@class='wHYlTd Ww4FFb vt6azd tF2Cxc asEBEc']") != null)//14-02-2025//31-12-2024//09-10-2024
                        {
                        continue;
                    }//09-10-2024
                    try
        ...
        public string ProcessOrganic(HtmlNode node)
        {
            ...
            if ((node.HasClass("_NId") || node.HasClass("bkWMgd") || node.HasClass("srg") //10-10-2022
                 ...
                 "|.//div[@class='g eejeod up9jud']|.//div[contains(@class,'Ww4FFb vt6azd')]|.//div[contains(@class,'PmEWq wHYlTd')]|.//div[contains(@class,'kb0PBd')]/div[@class='yuRUbf']") != null)//20-03-2025//25-04-2024//25-01-2023
