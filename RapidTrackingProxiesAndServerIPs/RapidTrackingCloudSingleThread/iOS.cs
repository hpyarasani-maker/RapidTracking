        ...
        public string ProcessDocument(string seid, string keyword, HtmlDocument doc)
        {
            ...
            try
            {
                ...
                if (nodeCol != null && nodeCol.Count <= 5 && doc.DocumentNode.SelectNodes("//div[contains(@id,'kp-wp-tab-')]") != null)//02-02-2024//31-01-2024
                    ...
                    "|.//div[@class='grvXqb fZ46zc']|.//g-card[@class='XqIXXe']|.//div[@id='knowledge-finance-wholepage__entity-summary']");//04-04-2025//02-04-2025//27-03-2025//01-01-2025//28-11-2024//26-09-2024//10-09-2024//09-05-2024//12-03-2024
                if (nodeCol == null)
