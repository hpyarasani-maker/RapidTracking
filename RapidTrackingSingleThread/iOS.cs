...
namespace RapidTrackingSingleThread
{
    class iOS
    {
        ...
        private string GetImages(HtmlNode node)
        {
            ...
            if (nds == null)
                nds = node.SelectNodes(".//div[@class='GNxIwf']/div[@jscontroller='xc1DSd']/a/g-inner-card/g-img[@class='BA0A6c']/img|.//div[@class='eA0Zlc JX86yc ivg-i']/g-inner-card/g-img[@class='BA0A6c']/img|.//div[@class='eA0Zlc qN5nNb ivg-i CxtVFd']/g-img[@class='BA0A6c']/img");//24-06-2020 //05-06-2020 included selector for images //13-01-2020 included selector for images
            if (nds == null)
