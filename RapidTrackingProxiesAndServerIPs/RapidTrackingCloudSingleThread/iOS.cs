    ...
    class iOS
    {
            ...
            if (nds != null)
            {
                foreach (HtmlNode nd in nds)
                {
                    try
                    {
                        ...
                        if (nd.SelectSingleNode(".//div[@class='ouy7Mc']") != null)//02-04-2023 People also Ask
                        {
            ...
            if (nodes != null)
            {
                foreach (HtmlNode nd in nodes)
                {
                    ...
                    if (link != null)
                    {
                        ...
                        name = link.SelectSingleNode(".//div[@class='DAB5ue']|.//div[@class='NemW5e']/span|.//div[contains(@class, 'ChC0jd')]/span|.//div[@class='kV5zMb Z454de']/span[1]|.//span[@class='rw5ecc RmEs5b rOlovd']|.//div[@class='n7emVc'] ")?.InnerText ?? "";//10-04-2023//16-03-2023 //27-02-2023//05-01-2023
                    }
        ...
        private bool IsBlock(HtmlNode node)
        {
            ...
            if (node.SelectSingleNode(".//div[contains(@class, 'Z3ngN')]") != null) //22-03-2021
                return false;
            if (node.SelectSingleNode(".//video-voyager[@class='LnSx5b']|.//div[@class='lNvPub v5yQqb']") != null)//15-03-2023//16-12-2021
