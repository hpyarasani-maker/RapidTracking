...
namespace RapidTrackingSingleThread
{
    public class Desktop
    {
        ...
        private string GetBottomStuff(HtmlDocument doc)
        {
            ...
            if (colb != null)
            {
                HtmlNodeCollection col = colb.SelectNodes(".//div[@id='tadsb']/ol/li|.//div[@id='tads']/div[@class='uEierd']|.//div[@id='tadsb']/div/div[@class='uEierd']");//28-03-2022 "/div" included //24-09-2020 bottom adwords//21-09-2020 updated bottom adwords   //20-01-2020
                if (col == null)
        ...
        private string GetTopStuff(HtmlDocument doc)
        {
            ...
            if (colt != null)
            {
                HtmlNodeCollection col = colt.SelectNodes(".//div[@id='tads']/ol/li|.//div[@id='tads']/div/ol/li|.//div[@id='tadsb']/ol/li|.//div[@id='tads']/div/div[@class='uEierd']");//29-03-2022 "/div/"included //21-09-2020 adwords selector//20-01-2020 //08-04-2020
