...
namespace RapidTrackingSingleThread
{
    class iOS
    {
            ...
            else
            {
                ...
                if (nds == null)
                    nds = node.SelectNodes(".//div[@class='mnr-c O9g5cc uUPGi']|.//div[@class='mnr-c xpd O9g5cc uUPGi']|.//div[@class='HD8Pae mnr-c xpd O9g5cc uUPGi']" +
                        ...
                        "|.//div[contains(@class,'card-section')]|.//div[@class='Lgnr0e J88qA vgnU9e BmP5tf']"); //20-08-2021 included contains//15-12-2020
        ...
        private bool IsBlock(HtmlNode node)
        {
            ...
            if (node.SelectSingleNode(".//div[@class='g card-section svwwZ']|.//div[@class='c6gxKe card-section']") != null) //03-11-2020
                return false;
