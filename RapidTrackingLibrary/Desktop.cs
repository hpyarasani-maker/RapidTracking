...
namespace RapidTrackingLibrary
{
    public class Desktop
    {
        ...
        {
            StringBuilder s = new StringBuilder();
            if ((node.HasClass("_NId") || node.HasClass("bkWMgd") || node.HasClass("srg") //10-10-2022 replaced 494 to 499
                ...
                || node.SelectNodes(".//div[@class='g tF2Cxc']|.//div[contains(@class,'g dFd2Tb')]|.//div[@class='g ZYT4Gf']") != null
                || node.SelectNodes(".//div[@class='d3zsgb']/div[@class='yuRUbf']|.//div[contains(@class,'g Ww4FFb')]") != null) && node.SelectSingleNode(".//div[@id='rhs']") == null)//end of 10-10-2022
            {
