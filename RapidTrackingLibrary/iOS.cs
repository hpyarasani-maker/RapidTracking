                ...
                if (nds == null)
                    if (node.SelectSingleNode(".//div[contains(@class,'YgXj7b')]") == null) //08-05-2021 applied contains//19-01-2021
                        nds = node.SelectNodes(".//div[contains(@class,'KJDcUb')]|.//div[@class='Lgnr0e J88qA vgnU9e BmP5tf']|.//g-card[@id='tscffb']|.//div[@class='mnr-c PHap3c']" +
                                        "|.//div[@jsname='wRSfy']|.//g-card[@class='g F6CFcc']|.//div[@class='mnr-c xpd O9g5cc uUPGi']" +
        ...
        /*private string PeopleAlsoAsk(HtmlNode node)//commented 19-01-2022
       {
        ...
        public string GetTopStories(HtmlNode node)
        {
            ...
            if (nds == null)
                ...
                nds = node.SelectNodes(".//div[contains(@class,'amp_re')]/a|.//div[contains(@class,'amp_re')]/div/a|.//div[@class='dbsr']/a|.//div[@class='Fq8eSd']/a|.//div[@class='y1Boce']/div/a|.//div[@data-ved]/a");//30-05-2022//28-07-2020   // 18-12-2019//27-07-2020
            if (nds != null)
                foreach (HtmlNode nd in nds)
                {
