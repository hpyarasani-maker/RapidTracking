            ...
            try
            {
                using (SqlConnection con = new SqlConnection(await StrConn()))
                {
                    ...
                    using (SqlCommand comm = con.CreateCommand())
                    {
                        ...
                        comm.Parameters.Add("Received", SqlDbType.VarChar).Value = "Normal Receive"; //14-04-2025
                        //comm.Parameters.Add("Received", SqlDbType.VarChar).Value = "New Keywords Receive"; //14-04-2025
                        await comm.ExecuteNonQueryAsync(); //06-08-2024
