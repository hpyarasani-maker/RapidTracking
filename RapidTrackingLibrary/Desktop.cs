    ...
    public class Desktop
    {
            ...
            try //28-09-2020  try catch.
            {
                ...
                {//08-02-2024
                    if (rso.SelectNodes("//div[contains(@id,'kp-wp-tab-')]") != null)
                        nodeCol = rso.SelectNodes(".//div[contains(@class,'TzHB6b cLjAic')]|.//div[contains(@class,'TzHB6b j8lBAb p7kDMc')]|.//div[contains(@class,'g Ww4FFb')]|.//div[@class='g PmEWq']|.//div[@class='Wt5Tfe']" +
                            "|.//div[@class='g']/div[@class='BYM4Nd']|.//div[@class='Lv2Cle']|.//g-section-with-header[contains(@class,'yG4QQe TBC9ub')]|.//div[@class='uVMCKf']|.//div[@class='vtSz8d']|.//div[@class='wHYlTd Ww4FFb vt6azd tF2Cxc asEBEc']|.//div[contains(@class,'PmEWq wHYlTd')]");//21-03-2025//18-02-2025//14-02-2025//31-12-2024//09-10-2024
                    else
        ...
        public string ProcessOrganic(HtmlNode node)
        {
            ...
            if ((node.HasClass("_NId") || node.HasClass("bkWMgd") || node.HasClass("srg") //10-10-2022
                 ...
                 "|.//div[@class='g eejeod up9jud']|.//div[contains(@class,'Ww4FFb vt6azd')]|.//div[contains(@class,'PmEWq wHYlTd')]|.//div[contains(@class,'kb0PBd')]//div[@class='yuRUbf']|.//div[@class='xe8e1b']|.//div[@class='BYM4Nd']") != null)//21-03-2025//20-03-2025//25-04-2024//25-01-2023
      ...
      /*private string PeopleAlsoAsk(HtmlNode node) //commented 19-01-2022
        ...
        private string GetPeopleAlsoAskUrls(string[] titles) //People also method 31-01-2022
        {
            ...
            string pattern1 = @"\\x22\\x3e\\x3ca jsname\\x3d\\x22UWckNb\\x22[ class\\x3d\\x22zReHs\\x22]*[ class\\x3d\\x22VfSr4c\\x22]* href\\x3d\\x22(.*?)\\x22*[ data-jsarwt\\x3d\\x221\\x22]";//16-12-2024//26-11-2024//08-09-2023
        ...
        public string GetBlockType(HtmlNode node)
        {
            ...
            if (node.SelectSingleNode(".//div[@id='imso-root']") != null || node.SelectSingleNode(".//div[@class='k9uN1c kfn9hb']") != null
                ...
                if (node.SelectSingleNode(".//div[@class='aeayCf mnr-c']|.//div/product-viewer-group|.//div[@class='aJegcc']|.//div[@id='iur']|.//div[@class='zxLiic']") == null)//17-12-2024//20-08-2024//29-07-2024//20-07-2024 //event and PeopleAlsoBuyFrom
                    return "Event";
