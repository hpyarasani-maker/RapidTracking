...
namespace RapidTrackingLoopReceiving
{
    public class Desktop
    {
        ...
        public string ProcessDocument(string seid, string keyword, string htmlsource, out int organicurls)
        {
            ...
            if (nodeCol == null)
                nodeCol = doc.DocumentNode.SelectNodes("//div[@id='rso']/div|//div[@id='rso']/g-section-with-header|//div[@class='Hpbsqe']|//div[@id='Odp5De']|//div[contains(@class,'TzHB6b cLjAic')]");//23-12-2021//08-10-2021 images //03-12-2020  //01-05-2020 
                ...
                foreach (HtmlNode nd in nodes)
                {
                    ...
                    try
                    {
                        ...
                        if (link != null)
                        {
                            ...
                            title = link.SelectSingleNode(".//div[@class='vuR1ld']|.//div[@class='wEN0R']|.//div[@class='vYe7gd Havxif']")?.InnerText;//13-12-2022
                            price = link.SelectSingleNode(".//div[@class='ldGAMe']|.//div[@class='z235y jAPStb']|.//div[@class='s1bFpb']")?.InnerText;//13-12-2022
                            name = link.SelectSingleNode(".//div[@class='DNnNed nbhTP']/span[@class='Dt4hCc']|.//div[@class='ix5OZc']|.//div[@class='pMiHCf']")?.InnerText;//13-12-2022
                        }
